      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-gray-800">
            My Favorites{" "}
            <span className="text-blue-600">({favoriteItems.length})</span>
          </h2>

          {favoriteItems.length > 0 && (
            <button
              onClick={() => navigate("/products")}
              className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-full text-sm font-medium transition-all flex items-center gap-2"
            >
              <svg
              ...
              >
                ...
                >
                  <img
                    ...
                    alt={item.name}
                    className="w-full object-cover object-top aspect-[4/5] group-hover:scale-105 transition-transform duration-300"
                  />
                ...
                <div className="p-4 flex-1 flex flex-col">
                  <div className="flex-1">
                    <h5 className="text-lg font-bold text-gray-800 line-clamp-1">
                      {item.name}
                    </h5>
                    ...
                    <div className="flex items-center gap-2 mt-3">
                      <h6 className="text-xl font-bold text-blue-600">
                        ${item.price}
                      </h6>
                      {item.oldPrice && (
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2">
                    <button
                      type="button"
                      className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-1"
                    ...
                    <button
                      type="button"
                      className="bg-white hover:bg-gray-50 text-red-600 border border-red-200 hover:border-red-300 text-sm font-medium py-2 px-4 rounded-lg transition-all flex items-center justify-center gap-1"
