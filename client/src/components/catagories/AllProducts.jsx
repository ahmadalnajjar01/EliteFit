    ...
    <div className="bg-gray-50 min-h-screen pb-12">
      ...
      <div className="bg-gradient-to-r from-pink-900 to-pink-700 text-white">
        <div className="container mx-auto px-4 py-16 md:py-24">
          ...
          <p className="text-pink-100 text-lg md:w-2/3 leading-relaxed">
            Discover our exclusive collection of products – curated just for
            you.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Optional Sorting/Filtering Controls */}
